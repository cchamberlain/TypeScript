        ...
        function getNodeSystem() {
            ...
            function useStdio(enable) {
                if (enable && !_fs._original) {
                    ...
                    var originalFS = _fs._originalFS;
                    _fs = originalFS;
                }
            }
...
(function (ts) {
    ts.Diagnostics = {
        ...
        Allows_compilation_of_a_stdin_stream_to_stdout: { code: 8020, category: ts.DiagnosticCategory.Message, key: "Allows_compilation_of_a_stdin_stream_to_stdout8020", message: "Allows compilation of a stdin stream to stdout." },
    };
})(ts || (ts = {}));
var ts;
(function (ts) {
...
(function (ts) {
    ...
    ts.optionDeclarations = [
        ...
        },
        {
            ...
            showInSimplifiedHelpView: true,
            category: ts.Diagnostics.Command_line_Options,
            description: ts.Diagnostics.Allows_compilation_of_a_stdin_stream_to_stdout
        },
        {
            name: "init",
            type: "boolean",
